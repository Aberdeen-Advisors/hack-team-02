...
const SYSTEM_PROMPT = [
  ...
  '7. Do not use an em dash (—) anywhere in the rationale text. Use a comma, a colon or a full stop instead.',
  '',
...
function fallback() {
  ...
  const rationale = SUB_FACTOR_KEYS.reduce((o, k) => {
    o[k] = 'No AI scoring available. This is a placeholder mid-scale value, not derived from the description. Review and adjust.';
    return o;
  }, {});
  return {
